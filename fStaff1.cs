...
namespace HotelManager
{
    public partial class fStaff : Form
    {
        ...
        private void DataBinding()
        {
            ...
            bindingSource.DataSource = dataGridStaff.DataSource;
            ...
            txbUserName.DataBindings.Add("Text", bindingSource, "UserName", true, DataSourceUpdateMode.Never);
            txbStartDay.DataBindings.Add("Text", bindingSource, "StartDay", true, DataSourceUpdateMode.Never);
            txbName.DataBindings.Add("Text", bindingSource, "DisplayName", true, DataSourceUpdateMode.Never);
            txbIDcard.DataBindings.Add("Text", bindingSource, "IDCardStaff", true, DataSourceUpdateMode.Never);
            comboBoxSex.DataBindings.Add("Text", bindingSource, "SexStaff", true, DataSourceUpdateMode.Never);
            datepickerDateOfBirth.DataBindings.Add("Value", bindingSource, "DateOfBirthStaff", true, DataSourceUpdateMode.Never);
            txbPhoneNumber.DataBindings.Add("Text", bindingSource, "PhoneNumberStaff", true, DataSourceUpdateMode.Never);
            txbAddress.DataBindings.Add("Text", bindingSource, "AddressStaff", true, DataSourceUpdateMode.Never);

            dataGridStaff.DataSource = bindingSource;
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                cMessageBox.Show("Vui lòng chuyển sang chế độ cập nhật trước khi cập nhật nhân viên.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            {
                cMessageBox.Show("Vui lòng chuyển sang chế độ xóa trước khi xóa nhân viên.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            string phoneNumber = txbPhoneNumber.Text.Trim();
            string userName = txbUserName.Text.Trim();
            string query = $"DELETE FROM Staff WHERE IDCardStaff=@IDCard AND PhoneNumberStaff=@PhoneNumber AND UserName=@UserName";
                ...
                using (SqlTransaction transaction = connection.BeginTransaction())
                {
                    try
                    {
                        using (SqlCommand command = new SqlCommand(query, connection, transaction))
                        {
                            ...
                            {
                                cMessageBox.Show("Không tìm thấy nhân viên có thông tin này.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            {
                cMessageBox.Show("Vui lòng chuyển sang chế độ thêm trước khi thêm nhân viên.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            {
                cMessageBox.Show("Tên người dùng đã tồn tại.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            {
                cMessageBox.Show("Vui lòng nhập đầy đủ thông tin.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }

            string query = "INSERT INTO Staff (IDStaff, UserName, DisplayName, PassWord, IDCardStaff, DateOfBirthStaff, SexStaff, AddressStaff, PhoneNumberStaff, StartDay, StatusLogin) " +
                           "VALUES (@IDStaff, @UserName, @DisplayName, @PassWord, @IDCardStaff, @DateOfBirthStaff, @SexStaff, @AddressStaff, @PhoneNumberStaff, @StartDay, @StatusLogin)";
            ...
            using (SqlConnection connection = new SqlConnection(connectstring))
            {
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    ...
                    command.Parameters.AddWithValue("@StatusLogin", "Offline"); 
                    connection.Open();
                    ...
                    if (rowsAffected > 0)
                    {
                        cMessageBox.Show("Nhân viên đã được thêm thành công.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
                        cMessageBox.Show("Không thể thêm nhân viên mới.", "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
            }
